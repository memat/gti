...
public class TelaListaDispositivo extends JInternalFrame {
	...
	private JLabel jlbPing1;
	
	public TelaListaDispositivo() {
	...
	private void criarDetalhes() {
		...
		jpnDetalhes.setBounds(614,40, 460, 409);
	...
	private void criarTitulo() {
		...
		getContentPane().add(jpnTitulo, BorderLayout.NORTH);
		...
		jpnTitulo.add(jlbTitulo, BorderLayout.CENTER);
